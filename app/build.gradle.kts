...
android {
    namespace = "com.example.birthdaylistoblopg"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.example.birthdaylistoblopg"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material:material-icons-extended:1.7.8") // cool icons for login
}